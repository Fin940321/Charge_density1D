...
# Ctrl + F "frame" to adjust auto or artificial frame range selection
...
print("=" * 70)
print("    Charge Density Analysis V9 - Auto-Detection Edition")
print("    \"Good taste means eliminating magic numbers\"")
print("=" * 70)
print()

### Load trajectory and analyze frames
...
### Detect electrode boundaries (NEW in V9)
...
### Setup histogram bins (NEW calculation in V9)
...
output_files = [
    ("hist_q_cat_2V.dat", density_cat, "cation"),
    ("hist_q_an_2V.dat", density_an, "anion"),
    ("hist_q_solv_2V.dat", density_solv, "solvent"),
    ("hist_q_total_2V.dat", density_total, "total")
]
...
plt.tight_layout()
plt.savefig("charge_density_2V.png", dpi=600, bbox_inches='tight')
print("  ✓ charge_density_2V.png")

print()
print("=" * 70)
print("✓ Analysis Complete - V9 Auto-Detection Edition")
print()
print("New features in V9:")
