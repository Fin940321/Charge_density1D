...
print("=" * 70)
print("    自動幀數計算版電荷密度分析 (V5 - Auto Frame Detection)")
print("=" * 70)
print()
...
print("  ✓ 已儲存: hist_q_solution_V5.dat")
...
print("  ✓ 已儲存圖表: charge_density_distribution_V5_auto.png")

print()
print("=" * 70)
print("✓ 所有處理完成！(V5 自動幀數計算版本)")
